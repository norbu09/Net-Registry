...
Net::Registry::NZRS::EPP - EPP libraries for the NZRS EPP interface
...
sub talk {
    ...
    #foreach my $req ( @{ $data } ) {
        ...
        push( @response, $hash );
    #}
    return { greet => $sock->{greet}, response => \@response };
}
...
sub _template {
    ...
    my $t = Template::Alloy->new( INCLUDE_PATH => [ $data->{account}->{template_path} ] );
    my $template = '';
...
Please report any bugs or feature requests to C<bug-Net::Registry::NZRS::EPP at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Net::Registry::NZRS::EPP>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Net::Registry::NZRS::EPP>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Net::Registry::NZRS::EPP>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Net::Registry::NZRS::EPP>

=item * Search CPAN

L<http://search.cpan.org/dist/Net::Registry::NZRS::EPP/>
...
1;    # End of Net::Registry::NZRS::EPP
